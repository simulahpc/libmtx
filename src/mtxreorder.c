    ...
    FILE * f)
{
    ...
    fprintf(f, "  --ordering=ORDERING\tordering to use: default, custom, metis, nd, scotch, rcm. [rcm]\n");
    ...
    fprintf(f, "\n");
    fprintf(f, " Options for METIS and SCOTCH are:\n");
...
int main(int argc, char *argv[])
{
    ...
    if ((args.ordering == mtxfile_metis || args.ordering == mtxfile_scotch) && args.rowpartsizespath) {
    ...
    if ((args.ordering == mtxfile_metis || args.ordering == mtxfile_scotch) && args.colpartsizespath) {
    ...
    err = mtxfile_reorder(
        ...
        args.nparts, rowpartsizes, colpartsizes, &objval,
    ...
    if (args.verbose > 0) {
        ...
        if (args.ordering == mtxfile_metis || args.ordering == mtxfile_scotch)
    ...
    if (!args.quiet) {
        ...
        } else if (args.ordering == mtxfile_metis || args.ordering == mtxfile_scotch) {
            err = mtxfilecomments_printf(
                &mtxfile.comments, "%% This file was generated by %s %s (%s, edge-cut: %'"PRId64")\n",
                program_name, program_version, mtxfileorderingstr(args.ordering), objval);
        } else {
            err = mtxfilecomments_printf(
    ...
    if ((args.ordering == mtxfile_metis || args.ordering == mtxfile_scotch) && args.colpartsizespath && !symmetric) {
