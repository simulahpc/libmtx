...
/**
 * `test_mtx_transpose_matrix_coordinate_real_general()` tests
 * transposing non-symmetric sparse matrices with real,
 * single-precision coefficients in the Matrix Market format.
 */
int test_mtx_transpose_matrix_coordinate_real_general(void)
{
    int err;
    struct mtx matrix;
...
/**
 * `test_mtx_transpose_matrix_coordinate_real_symmetric()` tests
 * transposing symmetric sparse matrices with real, single-precision
 * coefficients in the Matrix Market format.
 */
int test_mtx_transpose_matrix_coordinate_real_symmetric(void)
{
    int err;
    struct mtx matrix;
    int num_comment_lines = 0;
...
/**
 * `test_mtx_transpose_matrix_coordinate_double_general()` tests
 * transposing non-symmetric sparse matrices with real,
 * double-precision coefficients in the Matrix Market format.
 */
int test_mtx_transpose_matrix_coordinate_double_general(void)
{
    int err;
    struct mtx matrix;
    int num_comment_lines = 0;
...
/**
 * `test_mtx_transpose_matrix_coordinate_complex_general()` tests
 * transposing non-symmetric sparse matrices with real,
 * single-precision coefficients in the Matrix Market format.
 */
int test_mtx_transpose_matrix_coordinate_complex_general(void)
{
    int err;
    struct mtx matrix;
    int num_comment_lines = 0;
    ...
    TEST_ASSERT_EQ(   1, mtxdata[0].j);
    TEST_ASSERT_EQ( 1.0, mtxdata[0].a);
    TEST_ASSERT_EQ(-1.0, mtxdata[0].b);
    TEST_ASSERT_EQ(   4, mtxdata[1].i);
    TEST_ASSERT_EQ(   1, mtxdata[1].j);
    TEST_ASSERT_EQ( 2.0, mtxdata[1].a);
    TEST_ASSERT_EQ(-2.0, mtxdata[1].b);
    TEST_ASSERT_EQ(   2, mtxdata[2].i);
    TEST_ASSERT_EQ(   2, mtxdata[2].j);
    TEST_ASSERT_EQ( 3.0, mtxdata[2].a);
    TEST_ASSERT_EQ(-3.0, mtxdata[2].b);
    TEST_ASSERT_EQ(   3, mtxdata[3].i);
    TEST_ASSERT_EQ(   3, mtxdata[3].j);
    TEST_ASSERT_EQ( 4.0, mtxdata[3].a);
    TEST_ASSERT_EQ(-4.0, mtxdata[3].b);
    TEST_ASSERT_EQ(   1, mtxdata[4].i);
    TEST_ASSERT_EQ(   4, mtxdata[4].j);
    TEST_ASSERT_EQ( 5.0, mtxdata[4].a);
    TEST_ASSERT_EQ(-5.0, mtxdata[4].b);
    TEST_ASSERT_EQ(   4, mtxdata[5].i);
    TEST_ASSERT_EQ(   4, mtxdata[5].j);
    TEST_ASSERT_EQ( 6.0, mtxdata[5].a);
    TEST_ASSERT_EQ(-6.0, mtxdata[5].b);
    if (!err)
        mtx_free(&matrix);
    return TEST_SUCCESS;
}
...
/**
 * `test_mtx_transpose_matrix_coordinate_integer_general()` tests
 * transposing non-symmetric sparse matrices with integer coefficients
 * in the Matrix Market format.
 */
int test_mtx_transpose_matrix_coordinate_integer_general(void)
{
    int err;
    struct mtx matrix;
    int num_comment_lines = 0;
...
int main(int argc, char * argv[])
{
    ...
    TEST_RUN(test_mtx_transpose_matrix_coordinate_real_general);
    TEST_RUN(test_mtx_transpose_matrix_coordinate_real_symmetric);
    TEST_RUN(test_mtx_transpose_matrix_coordinate_double_general);
    TEST_RUN(test_mtx_transpose_matrix_coordinate_complex_general);
    TEST_RUN(test_mtx_transpose_matrix_coordinate_integer_general);
