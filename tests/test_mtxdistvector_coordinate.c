 ...
 *
 * Unit tests for distributed vectors in coordinate format.
 */
...
const char * program_invocation_short_name = "test_mtxdistvector_coordinate";

/**
 * ‘test_mtxdistvector_coordinate_from_mtxfile()’ tests converting
 * Matrix Market files stored on a single process to distributed
 * vectors.
 */
int test_mtxdistvector_coordinate_from_mtxfile(void)
{
    int err;
...

    {
        ...
        TEST_ASSERT_EQ(rank == 0 ? 4 : 3, interior->num_entries);
...
/**
 * ‘test_mtxdistvector_coordinate_to_mtxfile()’ tests converting distributed
 * vectors to Matrix Market files stored on a single process.
 */
int test_mtxdistvector_coordinate_to_mtxfile(void)
{
    int err;
    char mpierrstr[MPI_MAX_ERROR_STRING];
    int mpierrstrlen;
...
/**
 * ‘test_mtxdistvector_coordinate_from_mtxdistfile()’ tests converting
 * distributed Matrix Market files to distributed vectors.
 */
int test_mtxdistvector_coordinate_from_mtxdistfile(void)
{
    int err;
    char mpierrstr[MPI_MAX_ERROR_STRING];
    int mpierrstrlen;
...

    {
        ...
        TEST_ASSERT_EQ(mtx_double, interior->precision);
        if (rank == 0) {
            TEST_ASSERT_EQ(5, interior->num_entries);
            ...
            TEST_ASSERT_EQ(4, interior->num_entries);
...
/**
 * ‘test_mtxdistvector_coordinate_to_mtxdistfile()’ tests converting distributed
 * vectors to distributed Matrix Market files.
 */
int test_mtxdistvector_coordinate_to_mtxdistfile(void)
{
    int err;
    char mpierrstr[MPI_MAX_ERROR_STRING];
    int mpierrstrlen;
...
/**
 * ‘test_mtxdistvector_coordinate_dot()’ tests computing the dot products of
 * pairs of vectors.
 */
int test_mtxdistvector_coordinate_dot(void)
{
    int err;
    char mpierrstr[MPI_MAX_ERROR_STRING];
    int mpierrstrlen;
...
/**
 * ‘test_mtxdistvector_coordinate_nrm2()’ tests computing the Euclidean norm of
 * vectors.
 */
int test_mtxdistvector_coordinate_nrm2(void)
{
    int err;
    char mpierrstr[MPI_MAX_ERROR_STRING];
    int mpierrstrlen;
...
/**
 * ‘test_mtxdistvector_coordinate_scal()’ tests scaling vectors by a constant.
 */
int test_mtxdistvector_coordinate_scal(void)
{
    int err;
    char mpierrstr[MPI_MAX_ERROR_STRING];
    int mpierrstrlen;
...
/**
 * ‘test_mtxdistvector_coordinate_axpy()’ tests multiplying a vector by a constant
 * and adding the result to another vector.
 */
int test_mtxdistvector_coordinate_axpy(void)
{
    int err;
    char mpierrstr[MPI_MAX_ERROR_STRING];
    int mpierrstrlen;
...
int main(int argc, char * argv[])
{
    ...
    TEST_RUN(test_mtxdistvector_coordinate_from_mtxfile);
    TEST_RUN(test_mtxdistvector_coordinate_to_mtxfile);
    TEST_RUN(test_mtxdistvector_coordinate_from_mtxdistfile);
    TEST_RUN(test_mtxdistvector_coordinate_to_mtxdistfile);
    TEST_RUN(test_mtxdistvector_coordinate_dot);
    TEST_RUN(test_mtxdistvector_coordinate_nrm2);
    TEST_RUN(test_mtxdistvector_coordinate_scal);
    TEST_RUN(test_mtxdistvector_coordinate_axpy);
    TEST_SUITE_END();
