 ...
 *
 * Unit tests for distributed vectors in array format.
 */
...
const char * program_invocation_short_name = "test_mtxdistvector_array";

/**
 * ‘test_mtxdistvector_array_from_mtxfile()’ tests converting Matrix
 * Market files stored on a single process to distributed vectors.
 */
int test_mtxdistvector_array_from_mtxfile(void)
{
    int err;
...
/**
 * ‘test_mtxdistvector_array_to_mtxfile()’ tests converting
 * distributed vectors to Matrix Market files stored on a single
 * process.
 */
int test_mtxdistvector_array_to_mtxfile(void)
{
    int err;
    char mpierrstr[MPI_MAX_ERROR_STRING];
    int mpierrstrlen;
...
/**
 * ‘test_mtxdistvector_array_from_mtxdistfile()’ tests converting
 * distributed Matrix Market files to distributed vectors.
 */
int test_mtxdistvector_array_from_mtxdistfile(void)
{
    int err;
    char mpierrstr[MPI_MAX_ERROR_STRING];
    int mpierrstrlen;
...
/**
 * ‘test_mtxdistvector_array_to_mtxdistfile()’ tests converting
 * distributed vectors to distributed Matrix Market files.
 */
int test_mtxdistvector_array_to_mtxdistfile(void)
{
    int err;
    char mpierrstr[MPI_MAX_ERROR_STRING];
    int mpierrstrlen;
...
/**
 * ‘test_mtxdistvector_array_dot()’ tests computing the dot products
 * of pairs of vectors.
 */
int test_mtxdistvector_array_dot(void)
{
    int err;
    char mpierrstr[MPI_MAX_ERROR_STRING];
    int mpierrstrlen;
...
/**
 * ‘test_mtxdistvector_array_nrm2()’ tests computing the Euclidean
 * norm of vectors.
 */
int test_mtxdistvector_array_nrm2(void)
{
    int err;
    char mpierrstr[MPI_MAX_ERROR_STRING];
    int mpierrstrlen;
...
/**
 * ‘test_mtxdistvector_array_scal()’ tests scaling vectors by a
 * constant.
 */
int test_mtxdistvector_array_scal(void)
{
    int err;
    char mpierrstr[MPI_MAX_ERROR_STRING];
    int mpierrstrlen;
...
/**
 * ‘test_mtxdistvector_array_axpy()’ tests multiplying a vector by a
 * constant and adding the result to another vector.
 */
int test_mtxdistvector_array_axpy(void)
{
    int err;
    char mpierrstr[MPI_MAX_ERROR_STRING];
    int mpierrstrlen;
...
/**
 * ‘test_mtxdistvector_array_halo_update()’ tests performing halo
 * updates for distributed vectors.
 */
int test_mtxdistvector_array_halo_update(void)
{
    int err;
    char mpierrstr[MPI_MAX_ERROR_STRING];
    int mpierrstrlen;
...
int main(int argc, char * argv[])
{
    ...
    TEST_RUN(test_mtxdistvector_array_from_mtxfile);
    TEST_RUN(test_mtxdistvector_array_to_mtxfile);
    TEST_RUN(test_mtxdistvector_array_from_mtxdistfile);
    TEST_RUN(test_mtxdistvector_array_to_mtxdistfile);
    TEST_RUN(test_mtxdistvector_array_dot);
    TEST_RUN(test_mtxdistvector_array_nrm2);
    TEST_RUN(test_mtxdistvector_array_scal);
    TEST_RUN(test_mtxdistvector_array_axpy);
    TEST_RUN(test_mtxdistvector_array_halo_update);
    TEST_SUITE_END();
