...
/**
 * ‘test_mtxompcsr_from_mtxfile()’ tests converting Matrix
 * Market files to matrices.
 */
int test_mtxompcsr_from_mtxfile(void)
{
    int err;

    {
        ...
        struct mtxmatrix x;
        err = mtxmatrix_from_mtxfile(&x, mtxompcsr, &mtxfile);
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
        TEST_ASSERT_EQ(mtxompcsr, x.type);
        const struct mtxompcsr * x_ = &x.storage.ompcsr;
        ...
        TEST_ASSERT_EQ(mtx_field_real, x_->a.base.field);
        TEST_ASSERT_EQ(mtx_single, x_->a.base.precision);
        TEST_ASSERT_EQ(x_->a.base.data.real_single[0], 1.0f);
    ...
    }
    {
        ...
        TEST_ASSERT_EQ(mtx_field_real, x_->a.base.field);
        TEST_ASSERT_EQ(mtx_single, x_->a.base.precision);
        TEST_ASSERT_EQ(x_->a.base.data.real_single[0], 3.0f);
        TEST_ASSERT_EQ(x_->a.base.data.real_single[1], 4.0f);
        TEST_ASSERT_EQ(x_->a.base.data.real_single[2], 8.0f);
        mtxmatrix_free(&x);
        mtxfile_free(&mtxfile);
    }
    {
        ...
        TEST_ASSERT_EQ(x_->colidx[3], 2);
        TEST_ASSERT_EQ(mtx_field_real, x_->a.base.field);
        TEST_ASSERT_EQ(mtx_double, x_->a.base.precision);
        TEST_ASSERT_EQ(x_->a.base.data.real_double[0], 1.0);
    ...
    }
    {
        ...
        TEST_ASSERT_EQ(mtx_field_real, x_->a.base.field);
        TEST_ASSERT_EQ(mtx_double, x_->a.base.precision);
        TEST_ASSERT_EQ(x_->a.base.data.real_double[0], 3.0);
        TEST_ASSERT_EQ(x_->a.base.data.real_double[1], 4.0);
        TEST_ASSERT_EQ(x_->a.base.data.real_double[2], 8.0);
        mtxmatrix_free(&x);
        mtxfile_free(&mtxfile);
    }
    {
        ...
        TEST_ASSERT_EQ(x_->colidx[2], 0);
        TEST_ASSERT_EQ(x_->colidx[3], 2);
        TEST_ASSERT_EQ(mtx_field_complex, x_->a.base.field);
        TEST_ASSERT_EQ(mtx_single, x_->a.base.precision);
        TEST_ASSERT_EQ(x_->a.base.data.complex_single[0][0], 1.0f);
        TEST_ASSERT_EQ(x_->a.base.data.complex_single[0][1],-1.0f);
        TEST_ASSERT_EQ(x_->a.base.data.complex_single[1][0], 3.0f);
        TEST_ASSERT_EQ(x_->a.base.data.complex_single[1][1],-3.0f);
        TEST_ASSERT_EQ(x_->a.base.data.complex_single[2][0], 4.0f);
    ...
    }
    {
        ...
        TEST_ASSERT_EQ(mtx_field_complex, x_->a.base.field);
        TEST_ASSERT_EQ(mtx_single, x_->a.base.precision);
        TEST_ASSERT_EQ(x_->a.base.data.complex_single[0][0], 2.0f);
        TEST_ASSERT_EQ(x_->a.base.data.complex_single[0][1],-2.0f);
        TEST_ASSERT_EQ(x_->a.base.data.complex_single[1][0], 3.0f);
        TEST_ASSERT_EQ(x_->a.base.data.complex_single[1][1],-3.0f);
        TEST_ASSERT_EQ(x_->a.base.data.complex_single[2][0], 6.0f);
        TEST_ASSERT_EQ(x_->a.base.data.complex_single[2][1],-6.0f);
        mtxmatrix_free(&x);
        mtxfile_free(&mtxfile);
    }
    {
    ...
    }
    {
        ...
        TEST_ASSERT_EQ(mtx_field_complex, x_->a.base.field);
        TEST_ASSERT_EQ(mtx_double, x_->a.base.precision);
        TEST_ASSERT_EQ(x_->a.base.data.complex_double[0][0], 1.0);
        TEST_ASSERT_EQ(x_->a.base.data.complex_double[0][1],-1.0);
        TEST_ASSERT_EQ(x_->a.base.data.complex_double[1][0], 3.0);
        TEST_ASSERT_EQ(x_->a.base.data.complex_double[1][1],-3.0);
        TEST_ASSERT_EQ(x_->a.base.data.complex_double[2][0], 4.0);
        TEST_ASSERT_EQ(x_->a.base.data.complex_double[2][1],-4.0);
        TEST_ASSERT_EQ(x_->a.base.data.complex_double[3][0], 9.0);
        TEST_ASSERT_EQ(x_->a.base.data.complex_double[3][1],-9.0);
        mtxmatrix_free(&x);
        mtxfile_free(&mtxfile);
    }
    {
        ...
        TEST_ASSERT_EQ(x_->colidx[2], 0);
        TEST_ASSERT_EQ(x_->colidx[3], 2);
        TEST_ASSERT_EQ(mtx_field_integer, x_->a.base.field);
        TEST_ASSERT_EQ(mtx_single, x_->a.base.precision);
        TEST_ASSERT_EQ(x_->a.base.data.integer_single[0], 1);
    ...
    }
    {
        ...
        TEST_ASSERT_EQ(mtx_field_integer, x_->a.base.field);
        TEST_ASSERT_EQ(mtx_single, x_->a.base.precision);
        TEST_ASSERT_EQ(x_->a.base.data.integer_single[0], 2);
        TEST_ASSERT_EQ(x_->a.base.data.integer_single[1], 3);
        TEST_ASSERT_EQ(x_->a.base.data.integer_single[2], 6);
        mtxmatrix_free(&x);
        mtxfile_free(&mtxfile);
    }
    {
        ...
        TEST_ASSERT_EQ(mtx_field_integer, x_->a.base.field);
        TEST_ASSERT_EQ(mtx_double, x_->a.base.precision);
        TEST_ASSERT_EQ(x_->a.base.data.integer_double[0], 1);
    ...
    }
    {
        ...
        TEST_ASSERT_EQ(mtx_field_integer, x_->a.base.field);
        TEST_ASSERT_EQ(mtx_double, x_->a.base.precision);
        TEST_ASSERT_EQ(x_->a.base.data.integer_double[0], 2);
        TEST_ASSERT_EQ(x_->a.base.data.integer_double[1], 3);
        TEST_ASSERT_EQ(x_->a.base.data.integer_double[2], 6);
        mtxmatrix_free(&x);
        mtxfile_free(&mtxfile);
    }
    {
...
/**
 * ‘test_mtxompcsr_to_mtxfile()’ tests converting matrices
 * to Matrix Market files.
 */
int test_mtxompcsr_to_mtxfile(void)
{
    int err;

    {
        ...
        err = mtxmatrix_init_entries_real_single(
            &A, mtxompcsr, mtx_unsymmetric, num_rows, num_columns, nnz, rowidx, colidx, Adata);
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
        struct mtxfile mtxfile;
    ...
    }
    {
        ...
        struct mtxmatrix A;
        err = mtxmatrix_init_entries_real_single(
            &A, mtxompcsr, mtx_symmetric, num_rows, num_columns, nnz, rowidx, colidx, Adata);
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
        struct mtxfile mtxfile;
        err = mtxmatrix_to_mtxfile(&mtxfile, &A, 0, NULL, 0, NULL, mtxfile_coordinate);
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
    ...
    }
    {
        ...
        struct mtxmatrix A;
        err = mtxmatrix_init_entries_real_single(
            &A, mtxompcsr, mtx_skew_symmetric, num_rows, num_columns, nnz, rowidx, colidx, Adata);
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
        struct mtxfile mtxfile;
        err = mtxmatrix_to_mtxfile(&mtxfile, &A, 0, NULL, 0, NULL, mtxfile_coordinate);
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
    ...
    }
    {
        ...
        struct mtxmatrix A;
        err = mtxmatrix_init_entries_complex_single(
            &A, mtxompcsr, mtx_hermitian, num_rows, num_columns, nnz, rowidx, colidx, Adata);
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
        struct mtxfile mtxfile;
        err = mtxmatrix_to_mtxfile(&mtxfile, &A, 0, NULL, 0, NULL, mtxfile_coordinate);
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
    ...
    }
    {
        ...
        err = mtxmatrix_init_entries_pattern(
            &A, mtxompcsr, mtx_unsymmetric, num_rows, num_columns, nnz, rowidx, colidx);
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
        struct mtxfile mtxfile;
        err = mtxmatrix_to_mtxfile(&mtxfile, &A, 0, NULL, 0, NULL, mtxfile_coordinate);
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
...
/**
 * ‘test_mtxompcsr_partition_rowwise()’ tests partitioning
 * matrices rowwise.
 */
int test_mtxompcsr_partition_rowwise(void)
{
    int err;
    {
...
/**
 * ‘test_mtxompcsr_partition_columnwise()’ tests partitioning
 * matrices columnwise.
 */
int test_mtxompcsr_partition_columnwise(void)
{
    int err;
    {
        struct mtxmatrix src;
...
/**
 * ‘test_mtxompcsr_partition_2d()’ tests partitioning matrices in
 * a 2D manner.
 */
int test_mtxompcsr_partition_2d(void)
{
    int err;
    {
        struct mtxmatrix src;
...
/**
 * ‘test_mtxompcsr_split()’ tests splitting matrices.
 */
int test_mtxompcsr_split(void)
{
    int err;
    {
        struct mtxmatrix src;
        ...
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
        TEST_ASSERT_EQ(mtxompcsr, dst0.type);
        ...
        TEST_ASSERT_EQ(mtxompcsr, dst1.type);
...
/**
 * ‘test_mtxompcsr_gemv()’ tests computing matrix-vector
 * products for matrices in coordinate format.
 */
int test_mtxompcsr_gemv(void)
{
    int err;
...

    {
        ...
        err = mtxmatrix_init_entries_real_single(
            &A, mtxompcsr, mtx_unsymmetric, num_rows, num_columns, num_nonzeros, Arowidx, Acolidx, Adata);
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
        err = mtxvector_init_real_single(&x, mtxompvector, num_columns, xdata);
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
        {
            err = mtxvector_init_real_single(&y, mtxompvector, num_rows, ydata);
            TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
            err = mtxmatrix_sgemv(mtx_notrans, 2.0f, &A, &x, 3.0f, &y, NULL);
            TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
            TEST_ASSERT_EQ(mtxompvector, y.type);
            const struct mtxvector_base * y_ = &y.storage.omp.base;
...

    {
        ...
        float ydata[] = {1.0f, 0.0f, 2.0f};
        err = mtxmatrix_init_entries_real_single(
            &A, mtxompcsr, mtx_symmetric, num_rows, num_columns, num_nonzeros, Arowidx, Acolidx, Adata);
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
        err = mtxvector_init_real_single(&x, mtxompvector, num_columns, xdata);
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
        {
...

    {
        ...
        err = mtxmatrix_init_entries_real_double(
            &A, mtxompcsr, mtx_unsymmetric, num_rows, num_columns, num_nonzeros, Arowidx, Acolidx, Adata);
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
        err = mtxvector_init_real_double(&x, mtxompvector, num_columns, xdata);
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
        {
            err = mtxvector_init_real_double(&y, mtxompvector, num_rows, ydata);
            TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
            err = mtxmatrix_sgemv(mtx_notrans, 2.0f, &A, &x, 3.0f, &y, NULL);
            TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
            TEST_ASSERT_EQ(mtxompvector, y.type);
...

    {
        ...
        err = mtxmatrix_init_entries_complex_single(
            &A, mtxompcsr, mtx_unsymmetric, num_rows, num_columns, num_nonzeros, Arowidx, Acolidx, Adata);
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
        err = mtxvector_init_complex_single(&x, mtxompvector, num_columns, xdata);
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
        {
            err = mtxvector_init_complex_single(&y, mtxompvector, num_rows, ydata);
            TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
            err = mtxmatrix_sgemv(mtx_notrans, 2.0f, &A, &x, 3.0f, &y, NULL);
            TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
            TEST_ASSERT_EQ(mtxompvector, y.type);
...

    {
        ...
        float ydata[][2] = {{1.0f,0.0f}, {2.0f,2.0f}};
        err = mtxmatrix_init_entries_complex_single(
            &A, mtxompcsr, mtx_hermitian, num_rows, num_columns, num_nonzeros, Arowidx, Acolidx, Adata);
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
        err = mtxvector_init_complex_single(&x, mtxompvector, num_columns, xdata);
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
        {
...

    {
        ...
        err = mtxmatrix_init_entries_complex_double(
            &A, mtxompcsr, mtx_unsymmetric, num_rows, num_columns, num_nonzeros, Arowidx, Acolidx, Adata);
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
        err = mtxvector_init_complex_double(&x, mtxompvector, num_columns, xdata);
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
        {
            err = mtxvector_init_complex_double(&y, mtxompvector, num_rows, ydata);
            TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
            err = mtxmatrix_sgemv(mtx_notrans, 2.0f, &A, &x, 3.0f, &y, NULL);
            TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
            TEST_ASSERT_EQ(mtxompvector, y.type);
...

    {
        ...
        err = mtxmatrix_init_entries_integer_single(
            &A, mtxompcsr, mtx_unsymmetric, num_rows, num_columns, num_nonzeros, Arowidx, Acolidx, Adata);
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
        err = mtxvector_init_integer_single(&x, mtxompvector, num_columns, xdata);
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
        {
            err = mtxvector_init_integer_single(&y, mtxompvector, num_rows, ydata);
            TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
            err = mtxmatrix_sgemv(mtx_notrans, 2.0f, &A, &x, 3.0f, &y, NULL);
            TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
            TEST_ASSERT_EQ(mtxompvector, y.type);
...

    {
        ...
        err = mtxmatrix_init_entries_integer_double(
            &A, mtxompcsr, mtx_unsymmetric, num_rows, num_columns, num_nonzeros, Arowidx, Acolidx, Adata);
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
        err = mtxvector_init_integer_double(&x, mtxompvector, num_columns, xdata);
        TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
        {
            err = mtxvector_init_integer_double(&y, mtxompvector, num_rows, ydata);
            TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
            err = mtxmatrix_sgemv(mtx_notrans, 2.0f, &A, &x, 3.0f, &y, NULL);
            TEST_ASSERT_EQ_MSG(MTX_SUCCESS, err, "%s", mtxstrerror(err));
            TEST_ASSERT_EQ(mtxompvector, y.type);
...
int main(int argc, char * argv[])
{
    ...
    TEST_RUN(test_mtxompcsr_from_mtxfile);
    TEST_RUN(test_mtxompcsr_to_mtxfile);
    TEST_RUN(test_mtxompcsr_partition_rowwise);
    TEST_RUN(test_mtxompcsr_partition_columnwise);
    TEST_RUN(test_mtxompcsr_partition_2d);
    TEST_RUN(test_mtxompcsr_split);
    TEST_RUN(test_mtxompcsr_gemv);
    TEST_SUITE_END();
