...
/**
 * `test_mtx_permute_vector_array_real_single()' tests permuting the
 * elements of a single precision, real vector in array format.
 */
int test_mtx_permute_vector_array_real_single(void)
{
    int err;
    struct mtx mtx;
...
/**
 * `test_mtx_permute_vector_coordinate_real_single()' tests permuting the
 * elements of a sparse, real vector in the Matrix Market format.
 */
int test_mtx_permute_vector_coordinate_real_single(void)
{
    int err;
    struct mtx mtx;
    int num_comment_lines = 0;
...
/**
 * `test_mtx_permute_matrix_array_real_single()' tests permuting the
 * elements of a single precision, real matrix in array format.
 */
int test_mtx_permute_matrix_array_real_single(void)
{
    /* Permute rows. */
    {
        int err;
        ...
        TEST_ASSERT_EQ(9, matrix_array->size);
...
/**
 * `test_mtx_permute_matrix_coordinate_real_single()' tests permuting
 * the elements of a single precision, real matrix in coordinate
 * format.
 */
int test_mtx_permute_matrix_coordinate_real_single(void)
{
    /* Permute rows. */
    {
        int err;
...
/**
 * `test_mtx_permute_matrix_coordinate_pattern()' tests permuting the
 * elements of a pattern matrix in coordinate format.
 */
int test_mtx_permute_matrix_coordinate_pattern(void)
{
    /* Permute rows and columns.    */
    /*                              */
    /*    5--7--6           7--8--9 */
    ...
    TEST_ASSERT_EQ(mtx_single, matrix_coordinate->precision);
    TEST_ASSERT_EQ(24, matrix_coordinate->size);
...
/**
 * `test_mtx_matrix_reorder_rcm_coordinate_real_single()' tests
 * reordering the nonzeros of a single precision, real matrix in
 * coordinate format.
 */
int test_mtx_matrix_reorder_rcm_coordinate_real_single(void)
{
    int err;
    ...
    TEST_ASSERT_EQ(mtx_real, matrix_coordinate->field);
    TEST_ASSERT_EQ(mtx_single, matrix_coordinate->precision);
    TEST_ASSERT_EQ(10, matrix_coordinate->size);
    const struct mtx_matrix_coordinate_real_single * mtxdata =
        matrix_coordinate->data.real_single;
...
{
    TEST_SUITE_BEGIN("Running tests for reordering matrices and vectors\n");
    TEST_RUN(test_mtx_permute_vector_array_real_single);
    TEST_RUN(test_mtx_permute_vector_coordinate_real_single);
